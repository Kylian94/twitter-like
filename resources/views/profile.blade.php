    ...
    <div class="col-12 col-md-6 main-part border-left border-right p-0">
        ...
        <div class="px-3">
            ...
            <div class="mt-5 pt-3">
                ...
                <a href="{{ route('followers') }}" class="font-weight-light"><span class="font-weight-bold">{{count(Auth::user()->followers()->get())}}</span> followers</a>
                <a href="{{ route('followings') }}" class="font-weight-light ml-4"><span class="font-weight-bold">{{count(Auth::user()->followings()->get())}}</span> following</a>
                </div>
            </div>
        </div>
        <!-- NAV PANEL TAB PART-->
